defmodule UnwrappedWeb.Router do
  use UnwrappedWeb, :router

  import UnwrappedWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {UnwrappedWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: UnwrappedWeb.Telemetry
    end
  end
  ...
  scope "/", UnwrappedWeb do
    ...
    resources "/gift_ideas/:recipient_id/:giver_id", GiftIdeaController,
      only: [:new, :create, :delete, :edit, :show]
