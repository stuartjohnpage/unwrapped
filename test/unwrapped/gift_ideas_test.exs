defmodule Unwrapped.GiftIdeasTest do
  use Unwrapped.DataCase

  alias Unwrapped.GiftIdeas

  describe "gift_idea" do
    alias Unwrapped.GiftIdeas.GiftIdea

    import Unwrapped.GiftIdeasFixtures

    @invalid_attrs %{idea: nil}

    test "list_gift_idea/0 returns all gift_idea" do
      gift_idea = gift_idea_fixture()
      assert GiftIdeas.list_gift_idea() == [gift_idea]
    end
